...
// +kubebuilder:resource:scope=Cluster,shortName=nrq
...
type NamespaceResourceQuota struct {
	...
	Spec   NamespaceResourceQuotaSpec   `json:"spec,omitempty"`
	Status NamespaceResourceQuotaStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// NamespaceResourceQuotaList contains a list of NamespaceResourceQuota.
type NamespaceResourceQuotaList struct {
	metav1.TypeMeta `json:",inline"`
